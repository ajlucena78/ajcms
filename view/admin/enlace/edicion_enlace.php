...
<form action="<?php vlink('edicion-enlace'); ?>" method="post">
	<input type="hidden" name="id" value="<?php echo $enlace->idContenido; ?>" />
	...
	<div style="float: right; text-align: right; width: 70%;">
		<input type="text" name="metadesc" id="metadesc" style="width: 100%;" value="<?php 
				echo $enlace->metadesc; ?>" 
				<?php if ($enlace->tipoEnlace != 2)  { ?>disabled="disabled"<?php } ?> />
	</div>
